...
- [Как дебажить прогу](#как-дебажить-прогу)
  ...
  - [Вы не знаете где точка входа (например, она в функции main в си файле)](#вы-не-знаете-где-точка-входа-например-она-в-функции-main-в-си-файле)
- [Как дебажить то??](#как-дебажить-то)
