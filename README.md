...
![IDA ***** у радара, имхо](img/ida_sasat.png)

<details>

<summary>tree -L666 (СОДЕРЖАНИЕ)</summary>
...
![страничка откуда копировать команды](img/image-0.png)
...
> **Сложно?** Вспомните логотип IDA, нам такое не надо, мы - консольная элита с крутым лого, так что...
>
> *Keep calm and carry on!*
>
> Когда перейдете на 64 битную архитектуру, половину этих приколов не надо будет писать, плюс вы можете эту байду [запихать в конфиг](#как-сохранить-свои-пресеты).
>
> ![r2 learning curve](img/r2_learning_curve.png)
...
<details>
<summary>(Не переборщите с буквами `a` пожалуйста!!! Будет негативный опыт)</summary>

![НИКОГДА НЕ ПИШИТЕ aaaaaa!!!! ОНИ НАЙДУТ ВАС!](img/ida_sucks_really.jpg)
</details>
